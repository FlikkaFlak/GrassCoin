...
void ThreadIRCSeed(void* parg)
{
    ...
    RenameThread("GrassCoin-ircseed");
...
void ThreadIRCSeed2(void* parg)
{
    ...
    while (!fShutdown)
    {
        ...
        if (fTestNet) {
            ...
            Send(hSocket, strprintf("JOIN #GrassCoin%02d\r", channel_number).c_str());
            Send(hSocket, strprintf("WHO #GrassCoin%02d\r", channel_number).c_str());
        }
