...
unsigned int nStakeMaxAge = 7 * 24 * nOneHour; //  days as full weight
...
const string strMessageMagic = "GrassCoin Signed Message:\n";
...
{
    int64_t nRewardCoinYear = 25 * CENT;
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("GrassCoin-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in GrassCoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // GrassCoin: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "GrassCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Canada Expected to Legalize Cannabis by July 1 2018";
        CTransaction txNew;
        txNew.nTime = 1491716756;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1491716756;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1133717; // !fTestNet ? 1575379 : 46534;
	...
	//// debug print
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x7ce6a627fa2da68647d1e56c645b23cc6360af4e0ad873fb67a6b5d5c7e52373"));
